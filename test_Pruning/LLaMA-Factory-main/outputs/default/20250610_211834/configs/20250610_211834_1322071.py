datasets=[
    dict(abbr='HungarianExamMath',
        ...
        reader_cfg=dict(
            ...
            output_column=None),
        type='opencompass.datasets.HungarianExamMathDataset'),
    dict(abbr='game24',
        eval_cfg=dict(
            evaluator=dict(
                type='opencompass.datasets.Game24Evaluator'),
...
work_dir='outputs/default/20250610_211834'