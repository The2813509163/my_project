...
models=[
    dict(abbr='Llama-3.2-3B_hf',
        ...
        peft_path='/data/kris/qianxuzhen/Pruning-LLMs/LLaMA-Factory/saves/meta-llama__Llama-3.2-3B-tap0.9-learnable-interm/lora/sft/max_samples_dummy_1M_alpha_0.1',
        run_cfg=dict(
            num_gpus=1),
        stop_words=[
            ],
...
work_dir='outputs/default/20250819_054507'