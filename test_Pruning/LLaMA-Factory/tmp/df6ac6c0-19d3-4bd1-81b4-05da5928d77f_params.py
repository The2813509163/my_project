...
models = [
    dict(
        ...
        peft_kwargs=dict(),
        peft_path=
        '/deltadisk/guestnju/qianxuzhen/Pruning-LLMs/LLaMA-Factory/saves/meta-llama__Llama-3.2-1B-Instruct-tap0.5-learnable-interm/lora/sft/max_samples_10000',
...
work_dir = 'outputs/default/20250608_220639'
